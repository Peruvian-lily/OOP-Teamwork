...
namespace RPG.GameLogic.Models.NPC
{
    ...
    public class Enemy : Npc, IRoam, IEnemy
    {
        ...
        public void Update(GameTime gameTime)
        {
            this.animation.PlayAnimation(gameTime);            this.Animation.PlayAnimation(gameTime);
        }

        public void Draw(SpriteBatch spriteBatch)
        {
            this.animation.Draw(spriteBatch, this.Position);            this.Animation.Draw(spriteBatch, this.Position);
        }
    }
}
